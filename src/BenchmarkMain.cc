...
static void printUsage()
{
  ...
  cout << "5: \t DPIFlowClient" << endl;
  cout << "6: \t DPIFlowServer" << endl;
}
...
BenchmarkRunner *createTest(config_t &config)
{
  ...
  case 4:
    ...
    break;
  case 5:
    test = new DPIFlowInjectConsumeBenchmark(config, true);
    break;
  case 6:
    test = new DPIFlowInjectConsumeBenchmark(config, false);
    break;
  default:
    printUsage();
    exit(1);
